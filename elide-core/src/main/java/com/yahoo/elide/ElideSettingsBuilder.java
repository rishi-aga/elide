...
public class ElideSettingsBuilder {
    ...
    private boolean enableJPAFetchToManyRelationship;
    ...
    public ElideSettingsBuilder(DataStore dataStore) {
        ...
        this.enableJPAFetchToManyRelationship = false;
    ...
    public ElideSettings build() {
        ...
        return new ElideSettings(
                ...
                serdes,
                enableJsonLinks,
                enableJPAFetchToManyRelationship);
    }
    ...
    public ElideSettingsBuilder withJPAFetchToManyRelationship(boolean enable) {
        this.enableJPAFetchToManyRelationship = enable;
        return this;
    }
}
